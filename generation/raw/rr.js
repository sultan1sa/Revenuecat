...
[rewrite_local]
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-response-body https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/generation/raw/rr.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-request-header https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/generation/raw/rr.js
...
const list = {
  ...
  'Taio': { name: 'pro_lt', id: 'com.tk.client.lifetime', cm: 'sja' },  //Tiao
  'cgatultra': { name: 'Premium', id: 'cu_premium_yearly', cm: 'sjb' },  //手机硬件管家
  'totowallet': { name: 'plus', id: 'PlusYearly', cm: 'sjb' },  //图图记账
  'chatultra/': ['Premium','cu_premium_yearly'],
  'teak/': ['pro_lt','com.tk.client.lifetime'],
  'atomic': ['plus','PlusYearly']  //VSCO-照片与视频编辑
};
