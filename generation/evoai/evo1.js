...
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/generation/evoai/evo1.js
...
if (typeof $response == "undefined") {
  ...
  lovelovebabyforevey.subscriber.subscriptions["yearly_discounted"] = data;
  lovelovebabyforevey.subscriber.entitlements["premium"] = JSON.parse(JSON.stringify(data));
  lovelovebabyforevey.subscriber.entitlements["premium"].product_identifier = "yearly_discounted";
