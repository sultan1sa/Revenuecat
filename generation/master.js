...
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/generation/master.js
//^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/generation/master.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';
  const UAMappings = {
    'incognito': { name: 'annual', id: 'com.overdesigned.ShareBear.AnnualSubscription' },
    'teak': { name: 'pro', id: 'com.tk.client.lifetime' },
    'rochat': { name: 'premium', id: 'rochat_premium_lifetime01' },
