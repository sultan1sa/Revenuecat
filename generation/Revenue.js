...
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/[^/]+$) url script-response-body https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/generation/Revenue.js 
...
const mapping = {
  ...
  'SleepMaster/': ['jodel_premium','no_ads_v1_1yr_ar_full'],
  'jodel/': ['jodel_premium','no_ads_v1_1wk_ar_full'],
  'SleepMaster/': ['pro','com.tk.client.lifetime'],
