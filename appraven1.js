...
[rewrite_local]
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-response-body https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/appraven1.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-request-header https://raw.githubusercontent.com/sultan1sa/Revenuecat/main/appraven1.js
...
//识别bundle_id
const bundle = {
  'net.tengl.powertimer': { name: 'annual', id: 'com.overdesigned.ShareBear.AnnualSubscription', cm: 'sjb' },  //元气计时-PowerTimer
  'com.reader.book': { name: 'plus', id: 'PlusYearly', cm: 'sjb' },  //PureLibro
